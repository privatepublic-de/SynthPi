...
public class ControlMessageDispatcher implements IMidiNoteReceiver, IPitchBendReceiver {
	...
	private String createLabelMessage(int paramIndex) {
		...
		if (path!=null) {
			...
			if (paramIndex==P.FILTER1_TYPE || paramIndex==P.MOD_LFO_TYPE || paramIndex==P.OSC1_WAVE || paramIndex==P.OSC2_WAVE || paramIndex==P.OSC_SUB_SQUARE || paramIndex==P.DELAY_TYPE) {
