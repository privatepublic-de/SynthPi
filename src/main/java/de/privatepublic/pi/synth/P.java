...
public class P {
	...
	public static final int MOD_ENV2_OSC2_VOL_AMOUNT = 13;
...
//			MOD_AMOUNT_COMBINED = Math.max(VAL[MOD_WHEEL], VAL[MOD_AMOUNT_BASE]);
	...
	public static boolean setFromMIDI(int index, int val) {
		boolean valueChanged = false;
		if (index!=UNUSED) {
			float v = val==64?.5f:val/127f;
			set(index, v);
			valueChanged = VAL_RAW_MIDI[index]!=(int)val;
